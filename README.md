...
This documentation is **deprecated**. Documentation for the new API can still be found at [https://api.crossref.org/](https://api.crossref.org/), and issues should be reported to us via the [community forum](https://community.crossref.org/) or to support@crossref.org.
